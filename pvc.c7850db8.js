...
})({"1xjdH":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "843347a6c7850db8";
"use strict";
...
},{}],"16b6E":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _colourJs = require("./colour.js");
var _computerAgentJs = require("./computerAgent.js");
    ...
    document.querySelectorAll(`.js-tile`).forEach((tile)=>{
        tile.addEventListener('click', ()=>{
            ...
            if (tileFree[tileIndex]) {
                ...
                let fill = 0;
                for(let i = 0; i < check.length; i++)if (check[i] === false) fill++;
                if (fill === 9) ;
                else {
...
function whosMove() {
    if (difficulty === 'No Chance') (0, _computerAgentJs.computerStart)(tiles, tileFree);
    else if (difficulty === 'Extremely Hard') {
        let number = Math.random() * 2;
        let fiftyfifty = Math.floor(number);
        if (fiftyfifty === 1) (0, _computerAgentJs.computerStart)(tiles, tileFree);
    }
    technicalities();
}
...
},{"./colour.js":"3uSij","./computerAgent.js":"khi1d","../image/tic-tac-circle.webp":"7pcK7","../image/x.webp":"hPdVO","../image/previouse-page.webp":"cZL7t","../image/double-back-arrow.webp":"5xQPP","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"3uSij":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"khi1d":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ExtremelyHard", ()=>ExtremelyHard);
parcelHelpers.export(exports, "Hard", ()=>Hard);
parcelHelpers.export(exports, "NoChance", ()=>NoChance);
parcelHelpers.export(exports, "computerStart", ()=>computerStart);
var _ticTacXWebp = require("../image/tic-tac-x.webp");
var _ticTacXWebpDefault = parcelHelpers.interopDefault(_ticTacXWebp);
function ExtremelyHard(tiles, tileFree) {
    ...
    if (choice >= 1 && choice <= 5) {
        if (tiles[0] === 'computer-move' && tiles[1] === 'computer-move' && tileFree[2]) {
            jsTiles[2].innerHTML = `<img class="js-move grow move" src="${0, _ticTacXWebpDefault.default}">`;
            tileFree[2] = false;
            tiles[2] = 'computer-move';
        } else if (tiles[0] === 'computer-move' && tiles[4] === 'computer-move' && tileFree[8]) {
            jsTiles[8].innerHTML = `<img class="js-move grow move" src="${0, _ticTacXWebpDefault.default}">`;
            tileFree[8] = false;
            tiles[8] = 'computer-move';
        } else if (tiles[0] === 'computer-move' && tiles[2] === 'computer-move' && tileFree[1]) {
            jsTiles[1].innerHTML = `<img class="js-move grow move" src="${0, _ticTacXWebpDefault.default}">`;
            tileFree[1] = false;
            tiles[1] = 'computer-move';
        } else if (tiles[0] === 'computer-move' && tiles[6] === 'computer-move' && tileFree[3]) {
            jsTiles[3].innerHTML = `<img class="js-move grow move" src="${0, _ticTacXWebpDefault.default}">`;
            tileFree[3] = false;
            tiles[3] = 'computer-move';
        } else if (tiles[0] === 'computer-move' && tiles[3] === 'computer-move' && tileFree[6]) {
            jsTiles[6].innerHTML = `<img class="js-move grow move" src="${0, _ticTacXWebpDefault.default}">`;
            tileFree[6] = false;
            ...
            jsTiles[5].innerHTML = `<img class="js-move grow move" src="${0, _ticTacXWebpDefault.default}">`;
            tileFree[5] = false;
            tiles[5] = 'computer-move';
        } else if (tiles[6] === 'computer-move' && tiles[8] === 'computer-move' && tileFree[7]) {
            jsTiles[7].innerHTML = `<img class="js-move grow move" src="${0, _ticTacXWebpDefault.default}">`;
            tileFree[7] = false;
            ...
            jsTiles[0].innerHTML = `<img class="js-move grow move" src="${0, _ticTacXWebpDefault.default}">`;
            tileFree[0] = false;
            ...
            jsTiles[4].innerHTML = `<img class="js-move grow move" src="${0, _ticTacXWebpDefault.default}">`;
            tileFree[4] = false;
            ...
            for(let i = 1; i <= 9; i++)if (tileFree[i - 1]) {
                jsTiles[i - 1].innerHTML = `<img class="js-move grow move" src="${0, _ticTacXWebpDefault.default}">`;
                tileFree[i - 1] = false;
...
function Hard(tiles, tileFree) {
    console.log("This is the image url:", (0, _ticTacXWebpDefault.default));
    let number = Math.random() * 10;
    let choice = Math.floor(number);
    let jsTiles = [];
    document.querySelectorAll('.js-tile').forEach((tile)=>{
...
function NoChance(tiles, tileFree) {
    let number = Math.random() * 10;
    let choice = Math.floor(number);
    let jsTiles = [];
    document.querySelectorAll('.js-tile').forEach((tile)=>{
...
function computerStart(tiles, tileFree) {
...
},{"../image/tic-tac-x.webp":"1nMvw","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"1nMvw":[function(require,module,exports,__globalThis) {
...
},{}]},["1xjdH","16b6E"], "16b6E", "parcelRequire94c2", {}, "./", "/")

//# sourceMappingURL=pvc.c7850db8.js.map
